...
class DashboardRunActionsMixin:
    if TYPE_CHECKING:
        from PySide6.QtWidgets import QLabel, QSpinBox, QPushButton, QLineEdit
        from qfluentwidgets import SwitchButton, TogglePushButton
        ...
        random_ip_cb: TogglePushButton  # 实际类型是 TogglePushButton，不是 QCheckBox
        progress_bar: Any
        progress_pct: Any
        status_label: Any
        count_label: Any
        ...
        # 反填模式相关属性（来自 DashboardBackfillMixin）
        _backfill_enabled: bool
        _backfill_excel_path: str
        backfill_switch: SwitchButton
        backfill_path_label: QLabel
        backfill_excel_btn: QPushButton
        backfill_preview_btn: QPushButton
